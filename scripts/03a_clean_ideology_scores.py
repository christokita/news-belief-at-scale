...
Data In: CSV files containing list of Twitter user IDs and corresponding ideology (Pablo) score.
    `<data storage location>/data/ideological_scores/`
...
ideology_scores_directory = f"{data_directory}/data/ideological_scores/"
output_directory = f"{data_directory}/data_derived/ideological_scores/""
...
####################
# Original list
followers_original = pd.read_csv(f'{ideology_scores_directory}unique_followers_excl_tweeters--with_scores.csv',
...
followers_zerohedge = pd.read_csv(f'{ideology_scores_directory}unique_followers_zerohedge--with_scores.csv',
...
followers_cleaned.to_csv(f'{output_directory}cleaned_followers_ideology_scores.csv', index = False)
...
####################
friends = pd.read_csv(f'{ideology_scores_directory}unique_friends_excl_tweeters--with_scores.csv',
                      dtype = {'user_id': object, 'id_str': object})
friends_cleaned = clean_ideology_scores(friends)
friends_cleaned.to_csv(f'{output_directory}cleaned_friends_ideology_scores.csv', index = False)
...
####################
tweeters = pd.read_csv(f'{ideology_scores_directory}unique_tweeters_ideology_scores.csv',
                      dtype = {'user_id': object, 'id_str': object})
tweeters_cleaned = clean_ideology_scores(tweeters)
tweeters_cleaned.to_csv(f'{output_directory}cleaned_tweeter_ideology_scores.csv', index = False)
